...
from .tools import registry_default_tools
...
class ChatSession:
    ...
    def send_stream(self,content:str,**kwargs)->Generator:
    ...
    def send_with_tools(
        ...
        **kwargs,
        ...
        Returns:
            The assistant's response text (after tool execution).
        """
        ...
        # Append assistant reply to history if not already there
        if not any(
    ...
    def send_with_tools_stream(
        ...
        **kwargs,
        ...
        Yields:
            Text tokens as they arrive. Tool calls are executed internally.
        """
